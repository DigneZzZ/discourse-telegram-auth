...
## Версия 1.1.8 (6 июня 2025 г.) - ФИНАЛЬНАЯ СТАБИЛЬНАЯ ВЕРСИЯ ✅

### ✨ Исправления:
- **🐛 КРИТИЧЕСКОЕ ИСПРАВЛЕНИЕ**: Rails 7.2+ совместимость - исправлена ошибка middleware
- **⚙️ УЛУЧШЕНО**: Безопасная регистрация middleware с fallback механизмом
- **🛡️ ДОБАВЛЕНО**: Проверка существования ActionDispatch::ContentSecurityPolicy::Middleware

### 📁 Новые файлы:
- `RAILS_72_COMPATIBILITY_FIX.md` - отчет о фиксе совместимости с Rails 7.2+

### 🔧 Изменения в коде:
- Создан именованный класс `TelegramCSPMiddleware` вместо анонимного
- Добавлена проверка совместимости с различными версиями Rails
- Реализован fallback механизм для надежной работы middleware

---

## Версия 1.1.7 (6 июня 2025 г.)
